            ...
            <table class="event_calender table">
				...
				@foreach($events as $event)
				  <tr>
					...
					<td>
                        <a href="#" class="btn btn-primary btn-rounded" id="{{$event->id}}" name = "book_event">Book Ticket</a>
                    </td>
...
$( document ).ready(function() {
	$('select').on('change', function() {
	  window.location.href = "{{ URL::to('/view/events') }}"+"/"+this.value
	});
	$('.btn-rounded').click(function(){
		
		$.ajax({
		  url: "{{URL::to('/add/cart')}}"+"/"+this.id,
