...
<?php $__env->startSection('content'); ?>
    ...
    <body class="hold-transition register-page" style="background-image: url('<?php echo e(asset('assets/img/bg/slider.png')); ?>');">
    <div id="app" v-cloak>
        <div class="register-box">
            <div class="register-logo">
                <a href="<?php echo e(url('/home')); ?>" style="color:white"><b>Sign</b>UP</a>
            </div>
            ...
            <div class="register-box-body">
                ...
                <form action="<?php echo e(url('/register')); ?>" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="<?php echo e(trans('adminlte_lang::message.fullname')); ?>" name="name" value="<?php echo e(old('name')); ?>" autofocus/>
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <?php if(config('auth.providers.users.field','email') === 'username'): ?>
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" placeholder="<?php echo e(trans('adminlte_lang::message.username')); ?>" name="username" autofocus/>
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                    <?php endif; ?>
