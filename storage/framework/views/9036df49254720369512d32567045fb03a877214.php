...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo e(Request::path() == 'home' ? "active" : ""); ?>">
                <a href="<?php echo e(url('/view/events')); ?>">
                    <i class='fa fa-home'></i> 
                    <span>View Events</span>
                </a>
            </li>
            <li class="<?php echo e(Request::path() == 'admin/createevent' ? "active" : ""); ?>">
                <a href="<?php echo e(url('/admin/createevent')); ?>">
       ...
       <ul class="sidebar-menu">
        <li class="">
                ...
                <a href="<?php echo e(url('/logout')); ?>" class="btn btn-primary btn-block" id="logout"
