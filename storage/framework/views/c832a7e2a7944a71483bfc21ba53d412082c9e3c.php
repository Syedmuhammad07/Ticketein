    ...
    <div class="container">
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#headernav" aria-expanded="false" aria-label="Toggle navigation">
         ...
         <div class="collapse navbar-collapse flex-sm-row-reverse" id="headernav">
			...
			<?php if(!Auth::user()): ?>
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(url('/login')); ?>"></i>Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(url('/register')); ?>">Signup</a>
                </li>
			<?php else: ?>
				<li class="nav-item">
...
<section id="home" class="home-cover">
    <div class="cover_slider owl-carousel owl-theme">
        <div class="cover_item" style="background: url('<?php echo e(asset('assets/img/bg/slider.png')); ?>');">
        ...
        <div class="cover_item" style="background: url('<?php echo e(asset('assets/img/bg/bg-3.jpg')); ?>');">
            <div class="slider_content">
                <div class="slider-content-inner">
                    <div class="container">
                        <div class="slider-content-left">
                            ...
                            <a href="<?php echo e(url('/view/events')); ?>" class=" btn btn-primary btn-rounded" >
                                Buy Tickets Now
                            </a>
                        </div>
                    </div>
...
<!--event countdown -->
<section class="bg-img pt70 pb70" style="background-image:url('<?php echo e(asset('assets/img/bg/bg-img.png')); ?>');">
    ...
    <div class="container">
        ...
        <div class="brand_carousel owl-carousel">
            <div class="brand_item text-center">
                <img src="<?php echo e(asset('/assets/img/brands/b1.png')); ?>" alt="brand">
            </div>
            <div class="brand_item text-center">
                <img src="<?php echo e(asset('/assets/img/brands/b2.png')); ?>" alt="brand">
            </div>

            <div class="brand_item text-center">
                <img src="<?php echo e(asset('/assets/img/brands/b3.png')); ?>" alt="brand">
            </div>
            <div class="brand_item text-center">
                <img src="<?php echo e(asset('/assets/img/brands/b4.png')); ?>" alt="brand">
            </div>
            <div class="brand_item text-center">
                <img src="<?php echo e(asset('/assets/img/brands/b5.png')); ?>" alt="brand">
            </div>
        </div>
    </div>
</section>
