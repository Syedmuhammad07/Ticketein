...
<head>
    ...
    <link href="<?php echo e(asset('css/et-line.css')); ?>" rel="stylesheet">
...
<header class="header navbar fixed-top navbar-expand-md">
    <div class="container">
        <a class="navbar-brand logo" href="#">
            <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Evento"/>
        </a>
...
<!--page title section-->
<section class="inner_cover parallax-window" data-parallax="scroll" data-image-src="<?php echo e(asset('img/bg/bg-img.png')); ?>">
...
<section class="pt100 pb100">
    <div class="container">
        <img src="<?php echo e(asset('img/logo-dark.png')); ?>" alt="evento">
...
<!--get tickets section -->
<section class="bg-img pt100 pb100" style="background-image: url('<?php echo e(asset('img/bg/tickets.png')); ?>">
    <div class="container">
                ...
                <div class="footer_box">
                    ...
                    <div class="footer_box_body">
                        <ul class="instagram_list">
                            <li>
                                <a href="#">
                                    <img src="<?php echo e(asset('img/cleander/c1.png')); ?>" alt="instagram">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo e(asset('img/cleander/c2.png')); ?>" alt="instagram">
                                </a>
                            </li>
                            <li>
                                <a href="#">
                                    <img src="<?php echo e(asset('img/cleander/c3.png')); ?>" alt="instagram">
                                </a>
                            </li>
                            <li>
                                <a href="#">
